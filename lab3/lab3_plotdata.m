...
if strcmp(model_title, "jacobian_inverse_control")
    ...
    hold on;
    text(0.01,0.10,strcat("RMS Error = ", mat2str(RMS_joint_error,3)," deg"), 'Units', 'normalized');
    hold on;
    text(0.01,0.05,strcat("Max Error = ", mat2str(max_joint_error,3)," deg"), 'Units', 'normalized');
...
hold on;
text(0.01,0.10,strcat("RMS Error = ", mat2str(RMS_op_error,3)," m"), 'Units', 'normalized');
hold on;
text(0.01,0.05,strcat("Max Error = ", mat2str(max_op_error,3)," m"), 'Units', 'normalized');
